Project Autocomplete Sublime Text
===========================================================

Extends the default autocomplete to find matches in all files in opened project.
...
Start typing 'install' to select 'Package Control: Install Package', then search for ProjectAutocomplete and select it. That's it.
...
You can also install this package manually by entering the Packages directory of Sublime Text 2/3 and issuing on a terminal:
    ...
    git clone https://github.com/va-sorokin/SublimeProjectAutocomplete
